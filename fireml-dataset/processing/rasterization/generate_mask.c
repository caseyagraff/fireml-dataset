...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.rasterization.generate_mask",
        "sources": [
            "fireml/processing/rasterization/generate_mask.pyx"
        ]
    },
    "module_name": "fireml.processing.rasterization.generate_mask"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__rasterization__generate_mask
#define __PYX_HAVE_API__fireml__processing__rasterization__generate_mask
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'fireml.processing.rasterization.generate_mask' */
...
static double __pyx_f_6fireml_10processing_13rasterization_13generate_mask_magnitude(double, double); /*proto*/
static void __pyx_f_6fireml_10processing_13rasterization_13generate_mask_generate_mask_quadrant(__Pyx_memviewslice, char, char, double, int, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.rasterization.generate_mask"
extern int __pyx_module_is_main_fireml__processing__rasterization__generate_mask;
int __pyx_module_is_main_fireml__processing__rasterization__generate_mask = 0;

/* Implementation of 'fireml.processing.rasterization.generate_mask' */
...
/* "fireml/processing/rasterization/generate_mask.pyx":5
...
static double __pyx_f_6fireml_10processing_13rasterization_13generate_mask_magnitude(double __pyx_v_x, double __pyx_v_y) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("magnitude", 0);

  /* "fireml/processing/rasterization/generate_mask.pyx":6
 * 
 * cdef double magnitude(double x, double y):
 *     return sqrt(x**2 + y**2)             # <<<<<<<<<<<<<<
 * 
...
/* "fireml/processing/rasterization/generate_mask.pyx":8
 *     return sqrt(x**2 + y**2)
 * 
 * cdef void generate_mask_quadrant(             # <<<<<<<<<<<<<<
 *         unsigned char[:,:] mask,
...
static void __pyx_f_6fireml_10processing_13rasterization_13generate_mask_generate_mask_quadrant(__Pyx_memviewslice __pyx_v_mask, char __pyx_v_x_dir, char __pyx_v_y_dir, double __pyx_v_radius_grid_units, int __pyx_v_radius_grid_units_ceil, double __pyx_v_center_x, double __pyx_v_center_y) {
  double __pyx_v_x_adj;
  double __pyx_v_y_adj;
  double __pyx_v_distance;
  int __pyx_v_mask_width;
  int __pyx_v_mask_height;
  int __pyx_v_y_max;
  int __pyx_v_x_max;
  int __pyx_v_y;
  int __pyx_v_x;
  ...
  size_t __pyx_t_9;
  size_t __pyx_t_10;
  __Pyx_RefNannySetupContext("generate_mask_quadrant", 0);

  /* "fireml/processing/rasterization/generate_mask.pyx":18
 * 
 ...
 * 
 */
  __pyx_v_mask_width = (__pyx_v_mask.shape[0]);

  /* "fireml/processing/rasterization/generate_mask.pyx":19
 *     cdef double x_adj, y_adj, distance
 *     cdef int mask_width = mask.shape[0]
 *     cdef int mask_height = mask.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_mask_height = (__pyx_v_mask.shape[1]);

  /* "fireml/processing/rasterization/generate_mask.pyx":21
 *     cdef int mask_height = mask.shape[1]
 * 
 *     cdef int y_max = (radius_grid_units_ceil + 1)             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_y_max = (__pyx_v_radius_grid_units_ceil + 1);

  /* "fireml/processing/rasterization/generate_mask.pyx":22
 * 
 *     cdef int y_max = (radius_grid_units_ceil + 1)
 *     cdef int x_max = (radius_grid_units_ceil + 1)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_x_max = (__pyx_v_radius_grid_units_ceil + 1);

  /* "fireml/processing/rasterization/generate_mask.pyx":27
 *     cdef int y, x
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/rasterization/generate_mask.pyx":28
 * 
 *     for y in range(y_max):
 *         for x in range(x_max):             # <<<<<<<<<<<<<<
 *             x_adj = x * x_dir + center_x
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/rasterization/generate_mask.pyx":29
 *     for y in range(y_max):
 *         for x in range(x_max):
 *             x_adj = x * x_dir + center_x             # <<<<<<<<<<<<<<
 *             y_adj = y * y_dir + center_y
 * 
 */
      __pyx_v_x_adj = ((__pyx_v_x * __pyx_v_x_dir) + __pyx_v_center_x);

      /* "fireml/processing/rasterization/generate_mask.pyx":30
 *         for x in range(x_max):
 *             x_adj = x * x_dir + center_x
 *             y_adj = y * y_dir + center_y             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_y_adj = ((__pyx_v_y * __pyx_v_y_dir) + __pyx_v_center_y);

      /* "fireml/processing/rasterization/generate_mask.pyx":32
 *             y_adj = y * y_dir + center_y
 * 
 *             if x_adj < 0 or y_adj < 0 or x_adj >= mask_width or y_adj >= mask_height:             # <<<<<<<<<<<<<<
 *                 continue
 * 
 */
      __pyx_t_8 = ((__pyx_v_x_adj < 0.0) != 0);
      if (!__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = ((__pyx_v_y_adj < 0.0) != 0);
      if (!__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = ((__pyx_v_x_adj >= __pyx_v_mask_width) != 0);
      if (!__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = ((__pyx_v_y_adj >= __pyx_v_mask_height) != 0);
      __pyx_t_7 = __pyx_t_8;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_7) {

        /* "fireml/processing/rasterization/generate_mask.pyx":33
 * 
 *             if x_adj < 0 or y_adj < 0 or x_adj >= mask_width or y_adj >= mask_height:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "fireml/processing/rasterization/generate_mask.pyx":35
 *                 continue
 * 
 *             distance = magnitude(x,y)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_distance = __pyx_f_6fireml_10processing_13rasterization_13generate_mask_magnitude(__pyx_v_x, __pyx_v_y);

      /* "fireml/processing/rasterization/generate_mask.pyx":37
 *             distance = magnitude(x,y)
 * 
 *             if distance <= radius_grid_units:             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_7 = ((__pyx_v_distance <= __pyx_v_radius_grid_units) != 0);
      if (__pyx_t_7) {

        /* "fireml/processing/rasterization/generate_mask.pyx":38
 * 
 *             if distance <= radius_grid_units:
 *                 mask[<unsigned int>y_adj, <unsigned int>x_adj] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_9 = ((unsigned int)__pyx_v_y_adj);
        __pyx_t_10 = ((unsigned int)__pyx_v_x_adj);
        *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mask.data + __pyx_t_9 * __pyx_v_mask.strides[0]) ) + __pyx_t_10 * __pyx_v_mask.strides[1]) )) = 1;
...
/* "fireml/processing/rasterization/generate_mask.pyx":40
 *                 mask[<unsigned int>y_adj, <unsigned int>x_adj] = 1
 * 
 * cdef void generate_circle_mask(             # <<<<<<<<<<<<<<
 *         unsigned char [:,:] mask,
...
static void __pyx_f_6fireml_10processing_13rasterization_13generate_mask_generate_circle_mask(__Pyx_memviewslice __pyx_v_mask, unsigned short __pyx_v_radius, unsigned short __pyx_v_cell_size, double __pyx_v_center_x, double __pyx_v_center_y) {
  double __pyx_v_radius_grid_units;
  int __pyx_v_radius_grid_units_ceil;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  int __pyx_lineno = 0;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("generate_circle_mask", 0);

  /* "fireml/processing/rasterization/generate_mask.pyx":47
 *         double center_y):
 * 
 ...
 * 
 */
  if (unlikely(__pyx_v_cell_size == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 47, __pyx_L1_error)
  }
  __pyx_v_radius_grid_units = (((double)__pyx_v_radius) / ((double)__pyx_v_cell_size));

  /* "fireml/processing/rasterization/generate_mask.pyx":48
 * 
 *     cdef double radius_grid_units = radius / cell_size
 *     cdef int radius_grid_units_ceil = <int> ceil(radius_grid_units)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_radius_grid_units_ceil = ((int)ceil(__pyx_v_radius_grid_units));

  /* "fireml/processing/rasterization/generate_mask.pyx":50
 *     cdef int radius_grid_units_ceil = <int> ceil(radius_grid_units)
 * 
 *     generate_mask_quadrant(mask, 1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)             # <<<<<<<<<<<<<<
 *     generate_mask_quadrant(mask, 1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, -1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 */
  __pyx_f_6fireml_10processing_13rasterization_13generate_mask_generate_mask_quadrant(__pyx_v_mask, 1, 1, __pyx_v_radius_grid_units, __pyx_v_radius_grid_units_ceil, __pyx_v_center_x, __pyx_v_center_y);

  /* "fireml/processing/rasterization/generate_mask.pyx":51
 * 
 *     generate_mask_quadrant(mask, 1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, 1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)             # <<<<<<<<<<<<<<
 *     generate_mask_quadrant(mask, -1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 ...
 */
  ...
  /* "fireml/processing/rasterization/generate_mask.pyx":52
 *     generate_mask_quadrant(mask, 1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, 1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, -1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)             # <<<<<<<<<<<<<<
 *     generate_mask_quadrant(mask, -1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 ...
 */
  ...
  /* "fireml/processing/rasterization/generate_mask.pyx":53
 *     generate_mask_quadrant(mask, 1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, -1, 1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 *     generate_mask_quadrant(mask, -1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/rasterization/generate_mask.pyx":55
 *     generate_mask_quadrant(mask, -1, -1, radius_grid_units, radius_grid_units_ceil, center_x, center_y)
 * 
 *     mask[<unsigned int> center_y, <unsigned int> center_x] = 1             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = ((unsigned int)__pyx_v_center_y);
  __pyx_t_2 = ((unsigned int)__pyx_v_center_x);
  *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mask.data + __pyx_t_1 * __pyx_v_mask.strides[0]) ) + __pyx_t_2 * __pyx_v_mask.strides[1]) )) = 1;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fireml.processing.rasterization.generate_mask.generate_circle_mask", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.rasterization.generate_mask.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.generate_mask.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.generate_mask.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.generate_mask._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_generate_mask(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_generate_mask},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("generate_circle_mask", (void (*)(void))__pyx_f_6fireml_10processing_13rasterization_13generate_mask_generate_circle_mask, "void (__Pyx_memviewslice, unsigned short, unsigned short, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgenerate_mask(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgenerate_mask(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_generate_mask(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_generate_mask(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_generate_mask(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'generate_mask' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_generate_mask(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("generate_mask", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__rasterization__generate_mask) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.rasterization.generate_mask")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.rasterization.generate_mask", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/rasterization/generate_mask.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.rasterization.generate_mask", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.rasterization.generate_mask");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
