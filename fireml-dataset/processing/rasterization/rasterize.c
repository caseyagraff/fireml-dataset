...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.rasterization.rasterize",
        "sources": [
            "fireml/processing/rasterization/rasterize.pyx"
        ]
    },
    "module_name": "fireml.processing.rasterization.rasterize"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__rasterization__rasterize
#define __PYX_HAVE_API__fireml__processing__rasterization__rasterize
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
static unsigned long __pyx_v_6fireml_10processing_13rasterization_9rasterize_ONE_HOUR_NS;
...
static void __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_points(double *, size_t const , unsigned int const , unsigned int const , double const , double const ); /*proto*/
static CYTHON_INLINE double __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_point(double, unsigned int const , unsigned int const , double const ); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.rasterization.rasterize"
extern int __pyx_module_is_main_fireml__processing__rasterization__rasterize;
int __pyx_module_is_main_fireml__processing__rasterization__rasterize = 0;

/* Implementation of 'fireml.processing.rasterization.rasterize' */
...
static const char __pyx_k_ONE_HOUR_NS[] = "ONE_HOUR_NS";
...
static PyObject *__pyx_n_s_ONE_HOUR_NS;
...
/* "fireml/processing/rasterization/rasterize.pyx":6
 * 
 * 
...
static CYTHON_INLINE double __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_point(double __pyx_v_p, unsigned int const __pyx_v_raster_size, unsigned int const __pyx_v_cell_size, double const __pyx_v_center_point) {
  ...
  /* "fireml/processing/rasterization/rasterize.pyx":12
 ...
 */
  __pyx_v_offset = (__pyx_v_center_point - (((double)__pyx_v_raster_size) / 2.0));

  /* "fireml/processing/rasterization/rasterize.pyx":14
 *     cdef double offset = center_point - (raster_size / 2.0)
 * 
 *     return (p - offset) / cell_size             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = (__pyx_v_p - __pyx_v_offset);
  ...
  __pyx_r = (__pyx_t_1 / ((double)__pyx_v_cell_size));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fireml.processing.rasterization.rasterize.offset_and_scale_point", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "fireml/processing/rasterization/rasterize.pyx":16
 *     return (p - offset) / cell_size
 * 
 * cdef void offset_and_scale_points(             # <<<<<<<<<<<<<<
 *     double *points,
...
static void __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_points(double *__pyx_v_points, size_t const __pyx_v_num_points, unsigned int const __pyx_v_raster_size, unsigned int const __pyx_v_cell_size, double const __pyx_v_center_point_x, double const __pyx_v_center_point_y) {
  size_t __pyx_v_i;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  size_t __pyx_t_3;

  /* "fireml/processing/rasterization/rasterize.pyx":31
 *     cdef size_t i
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/rasterization/rasterize.pyx":32
 * 
 *     for i in range(num_points):
 *         points[i * 2] = offset_and_scale_point(points[i * 2], raster_size, cell_size, center_point_x)             # <<<<<<<<<<<<<<
 *         points[i * 2 + 1] = offset_and_scale_point(points[i * 2 + 1], raster_size, cell_size, center_point_y)
 ...
 */
    (__pyx_v_points[(__pyx_v_i * 2)]) = __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_point((__pyx_v_points[(__pyx_v_i * 2)]), __pyx_v_raster_size, __pyx_v_cell_size, __pyx_v_center_point_x);

    /* "fireml/processing/rasterization/rasterize.pyx":33
 *     for i in range(num_points):
 *         points[i * 2] = offset_and_scale_point(points[i * 2], raster_size, cell_size, center_point_x)
 *         points[i * 2 + 1] = offset_and_scale_point(points[i * 2 + 1], raster_size, cell_size, center_point_y)             # <<<<<<<<<<<<<<
 *         # points[i * 2] = (points[i * 2] - offset_x) / cell_size
 ...
 */
    (__pyx_v_points[((__pyx_v_i * 2) + 1)]) = __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_point((__pyx_v_points[((__pyx_v_i * 2) + 1)]), __pyx_v_raster_size, __pyx_v_cell_size, __pyx_v_center_point_y);
  }
...
/* "fireml/processing/rasterization/rasterize.pyx":40
...
static void __pyx_f_6fireml_10processing_13rasterization_9rasterize_rasterize_exact(__Pyx_memviewslice __pyx_v_raster, double *__pyx_v_points, size_t const __pyx_v_num_points, int const __pyx_v_cell_size, int const __pyx_v_raster_size, double const __pyx_v_center_point_x, double const __pyx_v_center_point_y, CYTHON_UNUSED unsigned long const __pyx_v_end_datetime) {
  double __pyx_v_point_x;
  double __pyx_v_point_y;
  size_t __pyx_v_i;
  size_t __pyx_v_raster_height;
  int __pyx_t_1;
  size_t __pyx_t_2;
  size_t __pyx_t_3;
  size_t __pyx_t_4;
  ...
  /* "fireml/processing/rasterization/rasterize.pyx":53
 *     cdef size_t i
 * 
 *     if num_points == 0:             # <<<<<<<<<<<<<<
 *         return
 * 
 */
  __pyx_t_1 = ((__pyx_v_num_points == 0) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/rasterization/rasterize.pyx":54
 * 
 *     if num_points == 0:
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/rasterization/rasterize.pyx":56
 *         return
 * 
 *     offset_and_scale_points(             # <<<<<<<<<<<<<<
 ...
 *     )
 */
  __pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_points(__pyx_v_points, __pyx_v_num_points, __pyx_v_raster_size, __pyx_v_cell_size, __pyx_v_center_point_x, __pyx_v_center_point_y);

  /* "fireml/processing/rasterization/rasterize.pyx":60
 *     )
 * 
 ...
 *     for i in range(num_points):
 */
  __pyx_v_raster_height = (__pyx_v_raster.shape[0]);

  /* "fireml/processing/rasterization/rasterize.pyx":62
 *     cdef size_t raster_height = raster.shape[0]
 * 
 *     for i in range(num_points):             # <<<<<<<<<<<<<<
 *         point_x = points[i * 2]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "fireml/processing/rasterization/rasterize.pyx":63
 * 
 *     for i in range(num_points):
 *         point_x = points[i * 2]             # <<<<<<<<<<<<<<
 *         point_y = raster_height - points[i * 2 + 1]
 * 
 */
    __pyx_v_point_x = (__pyx_v_points[(__pyx_v_i * 2)]);

    /* "fireml/processing/rasterization/rasterize.pyx":64
 *     for i in range(num_points):
 *         point_x = points[i * 2]
 *         point_y = raster_height - points[i * 2 + 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_point_y = (__pyx_v_raster_height - (__pyx_v_points[((__pyx_v_i * 2) + 1)]));

    /* "fireml/processing/rasterization/rasterize.pyx":66
 *         point_y = raster_height - points[i * 2 + 1]
 * 
 *         raster[<unsigned int> point_y, <unsigned int> point_x] = 1             # <<<<<<<<<<<<<<
 * 
 * # def rasterize_date(
 */
    __pyx_t_5 = ((unsigned int)__pyx_v_point_y);
    __pyx_t_6 = ((unsigned int)__pyx_v_point_x);
    *((unsigned char *) ( /* dim=1 */ ((char *) (((unsigned char *) ( /* dim=0 */ (__pyx_v_raster.data + __pyx_t_5 * __pyx_v_raster.strides[0]) )) + __pyx_t_6)) )) = 1;
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.rasterization.rasterize.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.rasterize.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.rasterize.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.rasterization.rasterize._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ONE_HOUR_NS, __pyx_k_ONE_HOUR_NS, sizeof(__pyx_k_ONE_HOUR_NS), 0, 0, 1, 1},
...
static int __Pyx_modinit_variable_export_code(void) {
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_ONE_HOUR_NS, (void *)&__pyx_v_6fireml_10processing_13rasterization_9rasterize_ONE_HOUR_NS, "unsigned long") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("offset_and_scale_points", (void (*)(void))__pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_points, "void (double *, size_t const , unsigned int const , unsigned int const , double const , double const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("rasterize_exact", (void (*)(void))__pyx_f_6fireml_10processing_13rasterization_9rasterize_rasterize_exact, "void (__Pyx_memviewslice, double *, size_t const , int const , int const , double const , double const , unsigned long const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("offset_and_scale_point", (void (*)(void))__pyx_f_6fireml_10processing_13rasterization_9rasterize_offset_and_scale_point, "double (double, unsigned int const , unsigned int const , double const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initrasterize(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initrasterize(void)
#else
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_rasterize(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("rasterize", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__rasterization__rasterize) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.rasterization.rasterize")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.rasterization.rasterize", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/rasterization/rasterize.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.rasterization.rasterize", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.rasterization.rasterize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
