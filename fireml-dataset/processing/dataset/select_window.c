...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.dataset.select_window",
        "sources": [
            "fireml/processing/dataset/select_window.pyx"
        ]
    },
    "module_name": "fireml.processing.dataset.select_window"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__dataset__select_window
#define __PYX_HAVE_API__fireml__processing__dataset__select_window
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
static void (*__pyx_f_6fireml_10processing_7dataset_6vector_push_item)(struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *, size_t); /*proto*/
...
static void __pyx_f_6fireml_10processing_7dataset_13select_window_select_spatial_window(__Pyx_memviewslice, unsigned long const , unsigned long const , double const , double const , unsigned int const , struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *); /*proto*/
static int __pyx_f_6fireml_10processing_7dataset_13select_window_compare_times(void const *, void const *); /*proto*/
static size_t __pyx_f_6fireml_10processing_7dataset_13select_window_search(void const *, void const *, size_t, size_t, int (*)(void const *, void const *)); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.dataset.select_window"
extern int __pyx_module_is_main_fireml__processing__dataset__select_window;
int __pyx_module_is_main_fireml__processing__dataset__select_window = 0;

/* Implementation of 'fireml.processing.dataset.select_window' */
...
/* "fireml/processing/dataset/select_window.pyx":5
...
static int __pyx_f_6fireml_10processing_7dataset_13select_window_compare_times(void const *__pyx_v_a, void const *__pyx_v_b) {
  unsigned long __pyx_v_a_v;
  unsigned long __pyx_v_b_v;
  int __pyx_r;
  int __pyx_t_1;

  /* "fireml/processing/dataset/select_window.pyx":6
 * 
 * cdef int compare_times(const void *a, const void *b) nogil:
 *     cdef unsigned long a_v = (<unsigned long*>a)[0]             # <<<<<<<<<<<<<<
 *     cdef unsigned long b_v = (<unsigned long*>b)[0]
 * 
 */
  __pyx_v_a_v = (((unsigned long *)__pyx_v_a)[0]);

  /* "fireml/processing/dataset/select_window.pyx":7
 * cdef int compare_times(const void *a, const void *b) nogil:
 *     cdef unsigned long a_v = (<unsigned long*>a)[0]
 *     cdef unsigned long b_v = (<unsigned long*>b)[0]             # <<<<<<<<<<<<<<
 * 
 *     if a_v < b_v:
 */
  __pyx_v_b_v = (((unsigned long *)__pyx_v_b)[0]);

  /* "fireml/processing/dataset/select_window.pyx":9
 *     cdef unsigned long b_v = (<unsigned long*>b)[0]
 * 
 *     if a_v < b_v:             # <<<<<<<<<<<<<<
 *         return -1;
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "fireml/processing/dataset/select_window.pyx":10
 * 
 *     if a_v < b_v:
 *         return -1;             # <<<<<<<<<<<<<<
 *     elif a_v > b_v:
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":11
 *     if a_v < b_v:
 *         return -1;
 *     elif a_v > b_v:             # <<<<<<<<<<<<<<
 *         return 1;
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "fireml/processing/dataset/select_window.pyx":12
 *         return -1;
 *     elif a_v > b_v:
 *         return 1;             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":14
 *         return 1;
 *     else:
 *         return 0;             # <<<<<<<<<<<<<<
 * 
...
/* "fireml/processing/dataset/select_window.pyx":17
 * 
 * # Insertion side = left
...
static size_t __pyx_f_6fireml_10processing_7dataset_13select_window_search(void const *__pyx_v_key, void const *__pyx_v_array, size_t __pyx_v_count, size_t __pyx_v_size, int (*__pyx_v_compare)(void const *, void const *)) {
  size_t __pyx_v_lo;
  size_t __pyx_v_hi;
  size_t __pyx_v_mid;
  int __pyx_v_res;
  ...
  /* "fireml/processing/dataset/select_window.pyx":18
 * # Insertion side = left
 * cdef size_t search(const void *key, const void *array, size_t count, size_t size, int (*compare)(const void *, const void *) nogil) nogil:
 *     if compare(key, array) <= 0:             # <<<<<<<<<<<<<<
 *         return 0;
 * 
 */
  __pyx_t_1 = ((__pyx_v_compare(__pyx_v_key, __pyx_v_array) <= 0) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/select_window.pyx":19
 * cdef size_t search(const void *key, const void *array, size_t count, size_t size, int (*compare)(const void *, const void *) nogil) nogil:
 *     if compare(key, array) <= 0:
 *         return 0;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":21
 *         return 0;
 * 
 *     if compare(key, array + size * (count - 1)) >= 0:             # <<<<<<<<<<<<<<
 *         return count - 1;
 * 
 */
  __pyx_t_1 = ((__pyx_v_compare(__pyx_v_key, (__pyx_v_array + (__pyx_v_size * (__pyx_v_count - 1)))) >= 0) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/select_window.pyx":22
 * 
 *     if compare(key, array + size * (count - 1)) >= 0:
 *         return count - 1;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":24
 *         return count - 1;
 * 
 *     cdef size_t lo = 0;             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":25
 * 
 *     cdef size_t lo = 0;
 *     cdef size_t hi = count;             # <<<<<<<<<<<<<<
 *     cdef size_t mid = count;
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":26
 *     cdef size_t lo = 0;
 *     cdef size_t hi = count;
 *     cdef size_t mid = count;             # <<<<<<<<<<<<<<
 *     cdef int res;
 * 
 */
  __pyx_v_mid = __pyx_v_count;

  /* "fireml/processing/dataset/select_window.pyx":29
 *     cdef int res;
 * 
 *     while lo < hi:             # <<<<<<<<<<<<<<
 *         mid = lo + (hi - lo) // 2;
 ...
 */
  while (1) {
    ...
    /* "fireml/processing/dataset/select_window.pyx":30
 * 
 *     while lo < hi:
 *         mid = lo + (hi - lo) // 2;             # <<<<<<<<<<<<<<
 *         res = compare(key, array + size * mid)
 * 
 */
    __pyx_v_mid = (__pyx_v_lo + ((__pyx_v_hi - __pyx_v_lo) / 2));

    /* "fireml/processing/dataset/select_window.pyx":31
 *     while lo < hi:
 *         mid = lo + (hi - lo) // 2;
 *         res = compare(key, array + size * mid)             # <<<<<<<<<<<<<<
 * 
 *         if res < 0:
 */
    __pyx_v_res = __pyx_v_compare(__pyx_v_key, (__pyx_v_array + (__pyx_v_size * __pyx_v_mid)));

    /* "fireml/processing/dataset/select_window.pyx":33
 *         res = compare(key, array + size * mid)
 * 
 *         if res < 0:             # <<<<<<<<<<<<<<
 *             hi = mid - 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "fireml/processing/dataset/select_window.pyx":34
 * 
 *         if res < 0:
 *             hi = mid - 1             # <<<<<<<<<<<<<<
 *         elif res > 0:
 ...
 */
    ...
    /* "fireml/processing/dataset/select_window.pyx":35
 *         if res < 0:
 *             hi = mid - 1
 *         elif res > 0:             # <<<<<<<<<<<<<<
 *             lo = mid + 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "fireml/processing/dataset/select_window.pyx":36
 *             hi = mid - 1
 *         elif res > 0:
 *             lo = mid + 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "fireml/processing/dataset/select_window.pyx":39
 *         else:
 *             # Key is equal to mid, move left until this changes
 *             while mid > 0:             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      while (1) {
        __pyx_t_1 = ((__pyx_v_mid > 0) != 0);
        if (!__pyx_t_1) break;

        /* "fireml/processing/dataset/select_window.pyx":40
 *             # Key is equal to mid, move left until this changes
 *             while mid > 0:
 *                 if compare(key, array + size * (mid - 1)) > 0 or mid == 0:             # <<<<<<<<<<<<<<
 *                     break
 * 
 */
        __pyx_t_2 = ((__pyx_v_compare(__pyx_v_key, (__pyx_v_array + (__pyx_v_size * (__pyx_v_mid - 1)))) > 0) != 0);
        if (!__pyx_t_2) {
        } else {
          __pyx_t_1 = __pyx_t_2;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_2 = ((__pyx_v_mid == 0) != 0);
        __pyx_t_1 = __pyx_t_2;
        __pyx_L11_bool_binop_done:;
        if (__pyx_t_1) {

          /* "fireml/processing/dataset/select_window.pyx":41
 *             while mid > 0:
 *                 if compare(key, array + size * (mid - 1)) > 0 or mid == 0:
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "fireml/processing/dataset/select_window.pyx":43
 *                     break
 * 
 *                 mid -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "fireml/processing/dataset/select_window.pyx":45
 *                 mid -= 1
 * 
 *             return mid;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":47
 *             return mid;
 * 
 *     if hi < 0:             # <<<<<<<<<<<<<<
 *         return 0
 * 
 */
  __pyx_t_1 = ((__pyx_v_hi < 0) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/select_window.pyx":48
 * 
 *     if hi < 0:
 *         return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":51
 * 
 *     # Move right if we overshot
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_compare(__pyx_v_key, (__pyx_v_array + (__pyx_v_size * __pyx_v_hi))) > 0) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L16_bool_binop_done;
    }
    __pyx_t_2 = ((__pyx_v_hi < (__pyx_v_count - 1)) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L16_bool_binop_done:;
    if (!__pyx_t_1) break;

    /* "fireml/processing/dataset/select_window.pyx":52
 *     # Move right if we overshot
 *     while compare(key, array + size * hi) > 0 and hi < (count - 1):
 *         hi += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_hi = (__pyx_v_hi + 1);
  }

  /* "fireml/processing/dataset/select_window.pyx":55
 * 
 *     # Move left if we overshot
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_compare(__pyx_v_key, (__pyx_v_array + (__pyx_v_size * (__pyx_v_hi - 1)))) <= 0) != 0);
    if (__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
      goto __pyx_L20_bool_binop_done;
    }
    __pyx_t_2 = ((__pyx_v_hi > 0) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L20_bool_binop_done:;
    if (!__pyx_t_1) break;

    /* "fireml/processing/dataset/select_window.pyx":56
 *     # Move left if we overshot
 *     while compare(key, array + size * (hi - 1)) <= 0 and hi > 0:
 *         hi -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/select_window.pyx":58
 *         hi -= 1
 * 
 *     return hi;             # <<<<<<<<<<<<<<
 * 
...
/* "fireml/processing/dataset/select_window.pyx":62
 * 
 * 
 * cdef (unsigned long, unsigned long) select_temporal_window(             # <<<<<<<<<<<<<<
 *     const unsigned long [::1] times,
...
static __pyx_ctuple_unsigned__space_long__and_unsigned__space_long __pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window(__Pyx_memviewslice __pyx_v_times, unsigned long const __pyx_v_datetime, unsigned long const __pyx_v_time_window_lower, unsigned long const __pyx_v_time_window_upper) {
  unsigned long __pyx_v_arr_length;
  unsigned long __pyx_v_start_time;
  unsigned long __pyx_v_end_time;
  size_t __pyx_v_start_ind;
  unsigned long __pyx_v_end_ind;
  __pyx_ctuple_unsigned__space_long__and_unsigned__space_long __pyx_r;
  Py_ssize_t __pyx_t_1;
  int __pyx_t_2;
  size_t __pyx_t_3;
  __pyx_ctuple_unsigned__space_long__and_unsigned__space_long __pyx_t_4;

  /* "fireml/processing/dataset/select_window.pyx":68
 ...
 */
  __pyx_v_arr_length = (__pyx_v_times.shape[0]);

  /* "fireml/processing/dataset/select_window.pyx":70
 *     cdef unsigned long arr_length = times.shape[0]
 * 
 *     cdef unsigned long start_time = datetime - time_window_lower             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_start_time = (__pyx_v_datetime - __pyx_v_time_window_lower);

  /* "fireml/processing/dataset/select_window.pyx":71
 * 
 *     cdef unsigned long start_time = datetime - time_window_lower
 *     cdef unsigned long end_time = datetime + time_window_upper             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_end_time = (__pyx_v_datetime + __pyx_v_time_window_upper);

  /* "fireml/processing/dataset/select_window.pyx":73
 *     cdef unsigned long end_time = datetime + time_window_upper
 * 
 *     cdef size_t start_ind = search(&start_time, &(times[0]), arr_length, sizeof(unsigned long), &compare_times)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = 0;
  __pyx_v_start_ind = __pyx_f_6fireml_10processing_7dataset_13select_window_search((&__pyx_v_start_time), (&(*((unsigned long const  *) ( /* dim=0 */ ((char *) (((unsigned long const  *) __pyx_v_times.data) + __pyx_t_1)) )))), __pyx_v_arr_length, (sizeof(unsigned long)), (&__pyx_f_6fireml_10processing_7dataset_13select_window_compare_times));

  /* "fireml/processing/dataset/select_window.pyx":75
 *     cdef size_t start_ind = search(&start_time, &(times[0]), arr_length, sizeof(unsigned long), &compare_times)
 * 
 *     cdef unsigned long end_ind = start_ind             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_end_ind = __pyx_v_start_ind;

  /* "fireml/processing/dataset/select_window.pyx":77
 *     cdef unsigned long end_ind = start_ind
 * 
 *     while end_ind < (arr_length - 1):             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_end_ind < (__pyx_v_arr_length - 1)) != 0);
    if (!__pyx_t_2) break;

    /* "fireml/processing/dataset/select_window.pyx":78
 * 
 *     while end_ind < (arr_length - 1):
 *         if times[end_ind + 1] >= end_time:             # <<<<<<<<<<<<<<
 *             break;
 * 
 */
    __pyx_t_3 = (__pyx_v_end_ind + 1);
    __pyx_t_2 = (((*((unsigned long const  *) ( /* dim=0 */ ((char *) (((unsigned long const  *) __pyx_v_times.data) + __pyx_t_3)) ))) >= __pyx_v_end_time) != 0);
    if (__pyx_t_2) {

      /* "fireml/processing/dataset/select_window.pyx":79
 *     while end_ind < (arr_length - 1):
 *         if times[end_ind + 1] >= end_time:
 *             break;             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "fireml/processing/dataset/select_window.pyx":81
 *             break;
 * 
 *         end_ind += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_end_ind = (__pyx_v_end_ind + 1);
  }
  __pyx_L4_break:;

  /* "fireml/processing/dataset/select_window.pyx":83
 *         end_ind += 1
 * 
 *     return start_ind, end_ind             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_4.f0 = __pyx_v_start_ind;
  __pyx_t_4.f1 = __pyx_v_end_ind;
  __pyx_r = __pyx_t_4;
  goto __pyx_L0;
...
/* "fireml/processing/dataset/select_window.pyx":85
 *     return start_ind, end_ind
 * 
 * cdef void select_spatial_window(             # <<<<<<<<<<<<<<
 *     const double [:,::1] xys,
...
static void __pyx_f_6fireml_10processing_7dataset_13select_window_select_spatial_window(__Pyx_memviewslice __pyx_v_xys, unsigned long const __pyx_v_start_ind, unsigned long const __pyx_v_end_ind, double const __pyx_v_center_x, double const __pyx_v_center_y, unsigned int const __pyx_v_window_size, struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *__pyx_v_inds) {
  CYTHON_UNUSED unsigned long __pyx_v_max_len;
  double __pyx_v_start_x;
  double __pyx_v_end_x;
  double __pyx_v_start_y;
  double __pyx_v_end_y;
  double __pyx_v_x;
  double __pyx_v_y;
  size_t __pyx_v_i;
  ...
  /* "fireml/processing/dataset/select_window.pyx":95
 *     ) nogil:
 * 
 ...
 */
  __pyx_v_max_len = (__pyx_v_end_ind - __pyx_v_start_ind);

  /* "fireml/processing/dataset/select_window.pyx":97
 *     cdef unsigned long max_len = end_ind - start_ind
 * 
 *     cdef double start_x = center_x - window_size / 2             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_start_x = (__pyx_v_center_x - (((double)__pyx_v_window_size) / 2.0));

  /* "fireml/processing/dataset/select_window.pyx":98
 * 
 *     cdef double start_x = center_x - window_size / 2
 *     cdef double end_x = center_x + window_size / 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_end_x = (__pyx_v_center_x + (((double)__pyx_v_window_size) / 2.0));

  /* "fireml/processing/dataset/select_window.pyx":100
 *     cdef double end_x = center_x + window_size / 2
 * 
 *     cdef double start_y = center_y - window_size / 2             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_start_y = (__pyx_v_center_y - (((double)__pyx_v_window_size) / 2.0));

  /* "fireml/processing/dataset/select_window.pyx":101
 * 
 *     cdef double start_y = center_y - window_size / 2
 *     cdef double end_y = center_y + window_size / 2             # <<<<<<<<<<<<<<
 * 
 *     cdef double x, y
 */
  __pyx_v_end_y = (__pyx_v_center_y + (((double)__pyx_v_window_size) / 2.0));

  /* "fireml/processing/dataset/select_window.pyx":108
 *     # inds: Vector* = []
 * 
 ...
 *         y = xys[i, 1]
 */
  __pyx_t_1 = __pyx_v_end_ind;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = __pyx_v_start_ind; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "fireml/processing/dataset/select_window.pyx":109
 * 
 *     for i in range(start_ind, end_ind):
 *         x = xys[i, 0]             # <<<<<<<<<<<<<<
 *         y = xys[i, 1]
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = 0;
    __pyx_v_x = (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_xys.data + __pyx_t_4 * __pyx_v_xys.strides[0]) )) + __pyx_t_5)) )));

    /* "fireml/processing/dataset/select_window.pyx":110
 *     for i in range(start_ind, end_ind):
 *         x = xys[i, 0]
 *         y = xys[i, 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = 1;
    __pyx_v_y = (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_xys.data + __pyx_t_4 * __pyx_v_xys.strides[0]) )) + __pyx_t_5)) )));

    /* "fireml/processing/dataset/select_window.pyx":112
 *         y = xys[i, 1]
 * 
 *         if (start_x <= x <= end_x) and (start_y <= y <= end_y):             # <<<<<<<<<<<<<<
 *             # ind_list.append(i)
 *             push_item(inds, i)
 */
    __pyx_t_7 = (__pyx_v_start_x <= __pyx_v_x);
    if (__pyx_t_7) {
      __pyx_t_7 = (__pyx_v_x <= __pyx_v_end_x);
    }
    ...
    __pyx_t_8 = (__pyx_v_start_y <= __pyx_v_y);
    if (__pyx_t_8) {
      __pyx_t_8 = (__pyx_v_y <= __pyx_v_end_y);
    }
    ...
    if (__pyx_t_6) {
      ...
      /* "fireml/processing/dataset/select_window.pyx":114
 *         if (start_x <= x <= end_x) and (start_y <= y <= end_y):
 *             # ind_list.append(i)
 *             push_item(inds, i)             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_f_6fireml_10processing_7dataset_6vector_push_item(__pyx_v_inds, __pyx_v_i);
...
/* "fireml/processing/dataset/select_window.pyx":117
 * 
 * 
...
static void __pyx_f_6fireml_10processing_7dataset_13select_window_select_spatiotemporal_window(__Pyx_memviewslice __pyx_v_times, __Pyx_memviewslice __pyx_v_xys, unsigned long const __pyx_v_datetime, unsigned long const __pyx_v_time_window_lower, unsigned long const __pyx_v_time_window_upper, double const __pyx_v_center_x, double const __pyx_v_center_y, unsigned int const __pyx_v_window_size, struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *__pyx_v_inds) {
  ...
  /* "fireml/processing/dataset/select_window.pyx":130
 ...
 */
  __pyx_t_1 = __pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window(__pyx_v_times, __pyx_v_datetime, __pyx_v_time_window_lower, __pyx_v_time_window_upper);
  __pyx_t_2 = __pyx_t_1.f0;
  __pyx_t_3 = __pyx_t_1.f1;
  __pyx_v_start_ind = __pyx_t_2;
  __pyx_v_end_ind = __pyx_t_3;

  /* "fireml/processing/dataset/select_window.pyx":132
 *     start_ind, end_ind = select_temporal_window(times, datetime, time_window_lower, time_window_upper)
 * 
 *     if start_ind != end_ind:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_4 = ((__pyx_v_start_ind != __pyx_v_end_ind) != 0);
  if (__pyx_t_4) {

    /* "fireml/processing/dataset/select_window.pyx":133
 * 
 *     if start_ind != end_ind:
 *         select_spatial_window(xys, start_ind, end_ind, center_x, center_y, window_size, inds)             # <<<<<<<<<<<<<<
 * 
 */
    __pyx_f_6fireml_10processing_7dataset_13select_window_select_spatial_window(__pyx_v_xys, __pyx_v_start_ind, __pyx_v_end_ind, __pyx_v_center_x, __pyx_v_center_y, __pyx_v_window_size, __pyx_v_inds);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.dataset.select_window.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.select_window.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.select_window.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.select_window._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("select_temporal_window", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window, "__pyx_ctuple_unsigned__space_long__and_unsigned__space_long (__Pyx_memviewslice, unsigned long const , unsigned long const , unsigned long const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("select_spatial_window", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_13select_window_select_spatial_window, "void (__Pyx_memviewslice, unsigned long const , unsigned long const , double const , double const , unsigned int const , struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("select_spatiotemporal_window", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_13select_window_select_spatiotemporal_window, "void (__Pyx_memviewslice, __Pyx_memviewslice, unsigned long const , unsigned long const , unsigned long const , double const , double const , unsigned int const , struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "push_item", (void (**)(void))&__pyx_f_6fireml_10processing_7dataset_6vector_push_item, "void (struct __pyx_t_6fireml_10processing_7dataset_6vector_Vector *, size_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__dataset__select_window) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.dataset.select_window")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.dataset.select_window", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/dataset/select_window.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.dataset.select_window", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.dataset.select_window");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
