...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.dataset.realtime.land_cover",
        "sources": [
            "fireml/processing/dataset/realtime/land_cover.pyx"
        ]
    },
    "module_name": "fireml.processing.dataset.realtime.land_cover"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__dataset__realtime__land_cover
#define __PYX_HAVE_API__fireml__processing__dataset__realtime__land_cover
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <math.h>
...
/* Module declarations from 'fireml.processing.dataset.realtime.pooling' */
static void (*__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d)(float *, size_t const , __Pyx_memviewslice); /*proto*/
static void (*__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_3d)(float *, size_t const , __Pyx_memviewslice); /*proto*/

/* Module declarations from 'fireml.processing.dataset.realtime.land_cover' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static size_t __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE;
static short __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_MISSING_VALUE;
static short __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_UNKNOWN_VALUE;
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_2d(float *, __Pyx_memviewslice); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_3d(float *, __Pyx_memviewslice); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_memview_to_raster(__Pyx_memviewslice, float *); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_extract_raster(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *, float *, __Pyx_memviewslice, size_t, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster(float *, __Pyx_memviewslice, size_t, size_t); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_convert_evt_classes(float *, size_t, __Pyx_memviewslice); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_one_hot_encode(float *, float *, size_t, unsigned int); /*proto*/
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster_evt(float *, float *, __Pyx_memviewslice, size_t, size_t, unsigned char, unsigned int, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.dataset.realtime.land_cover"
extern int __pyx_module_is_main_fireml__processing__dataset__realtime__land_cover;
int __pyx_module_is_main_fireml__processing__dataset__realtime__land_cover = 0;

/* Implementation of 'fireml.processing.dataset.realtime.land_cover' */
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":16
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_2d(float *__pyx_v_raster, __Pyx_memviewslice __pyx_v_memview) {
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":20
 *     float [:, ::1] memview
 * ) nogil:
 ...
 * 
 */
  __pyx_v_width = (__pyx_v_memview.shape[0]);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":23
 *     cdef size_t i, j
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":24
 * 
 *     for i in range(width):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             memview[i,j] = raster[i * width + j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":25
 *     for i in range(width):
 *         for j in range(width):
 *             memview[i,j] = raster[i * width + j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_memview.data + __pyx_t_7 * __pyx_v_memview.strides[0]) )) + __pyx_t_8)) )) = (__pyx_v_raster[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]);
    }
  }
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":30
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_3d(float *__pyx_v_raster, __Pyx_memviewslice __pyx_v_memview) {
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":34
 *     float [:, :, ::1] memview
 * ) nogil:
 ...
 *     cdef size_t i, j, k
 */
  __pyx_v_num_layers = (__pyx_v_memview.shape[0]);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":35
 * ) nogil:
 *     cdef size_t num_layers = memview.shape[0]
 *     cdef size_t width = memview.shape[1]             # <<<<<<<<<<<<<<
 *     cdef size_t i, j, k
 * 
 */
  __pyx_v_width = (__pyx_v_memview.shape[1]);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":38
 *     cdef size_t i, j, k
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":39
 * 
 *     for i in range(num_layers):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             for k in range(width):
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":40
 *     for i in range(num_layers):
 *         for j in range(width):
 *             for k in range(width):             # <<<<<<<<<<<<<<
 *                 memview[i,j,k] = raster[i * width * width + j * width + k]
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "fireml/processing/dataset/realtime/land_cover.pyx":41
 *         for j in range(width):
 *             for k in range(width):
 *                 memview[i,j,k] = raster[i * width * width + j * width + k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_memview.data + __pyx_t_10 * __pyx_v_memview.strides[0]) ) + __pyx_t_11 * __pyx_v_memview.strides[1]) )) + __pyx_t_12)) )) = (__pyx_v_raster[((((__pyx_v_i * __pyx_v_width) * __pyx_v_width) + (__pyx_v_j * __pyx_v_width)) + __pyx_v_k)]);
      }
    }
  }
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":43
 *                 memview[i,j,k] = raster[i * width * width + j * width + k]
 * 
 * cdef void copy_memview_to_raster(             # <<<<<<<<<<<<<<
 *     short [:, ::1] memview,
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_memview_to_raster(__Pyx_memviewslice __pyx_v_memview, float *__pyx_v_raster) {
  size_t __pyx_v_width;
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  size_t __pyx_t_1;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":47
 *     float *raster
 * ) nogil:
 *     cdef size_t width = memview.shape[0]             # <<<<<<<<<<<<<<
 *     cdef size_t i, j
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":50
 *     cdef size_t i, j
 * 
 *     for i in range(width):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":51
 * 
 *     for i in range(width):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             raster[i * width + j] = memview[i,j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":52
 *     for i in range(width):
 *         for j in range(width):
 *             raster[i * width + j] = memview[i,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      (__pyx_v_raster[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]) = (*((short *) ( /* dim=1 */ ((char *) (((short *) ( /* dim=0 */ (__pyx_v_memview.data + __pyx_t_7 * __pyx_v_memview.strides[0]) )) + __pyx_t_8)) )));
    }
  }
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":54
 *             raster[i * width + j] = memview[i,j]
 * 
 * cdef void extract_raster(             # <<<<<<<<<<<<<<
 *     Point* point,
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_extract_raster(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *__pyx_v_point, float *__pyx_v_raster, __Pyx_memviewslice __pyx_v_land_cover_layer, size_t __pyx_v_width, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform __pyx_v_t) {
  size_t __pyx_v_col;
  size_t __pyx_v_row;
  size_t __pyx_v_layer_height;
  size_t __pyx_v_layer_width;
  size_t __pyx_v_offset;
  size_t __pyx_v_round_off;
  size_t __pyx_v_top;
  size_t __pyx_v_bottom;
  size_t __pyx_v_left;
  size_t __pyx_v_right;
  size_t __pyx_v_top_b;
  size_t __pyx_v_bottom_b;
  size_t __pyx_v_left_b;
  size_t __pyx_v_right_b;
  CYTHON_UNUSED size_t __pyx_v_a;
  CYTHON_UNUSED size_t __pyx_v_b;
  CYTHON_UNUSED size_t __pyx_v_c;
  CYTHON_UNUSED size_t __pyx_v_d;
  size_t __pyx_t_1;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":61
 *     Transform t
 * ) nogil:
 ...
 * 
 */
  __pyx_v_col = ((size_t)__pyx_f_6fireml_10processing_7dataset_8realtime_9transform_apply_inverse_transform(__pyx_v_t, __pyx_v_point->x, __pyx_v_point->y).f0);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":62
 * ) nogil:
 *     cdef size_t col = <size_t> apply_inverse_transform(t, point.x, point.y)[0]
 *     cdef size_t row = <size_t> apply_inverse_transform(t, point.x, point.y)[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_row = ((size_t)__pyx_f_6fireml_10processing_7dataset_8realtime_9transform_apply_inverse_transform(__pyx_v_t, __pyx_v_point->x, __pyx_v_point->y).f1);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":64
 *     cdef size_t row = <size_t> apply_inverse_transform(t, point.x, point.y)[1]
 * 
 *     cdef size_t layer_height = land_cover_layer.shape[0];             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_layer_height = (__pyx_v_land_cover_layer.shape[0]);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":65
 * 
 *     cdef size_t layer_height = land_cover_layer.shape[0];
 *     cdef size_t layer_width = land_cover_layer.shape[1];             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_layer_width = (__pyx_v_land_cover_layer.shape[1]);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":67
 *     cdef size_t layer_width = land_cover_layer.shape[1];
 * 
 *     cdef size_t offset = width // 2             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_offset = (__pyx_v_width / 2);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":68
 * 
 *     cdef size_t offset = width // 2
 *     cdef size_t round_off = width % 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_round_off = (__pyx_v_width % 2);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":70
 *     cdef size_t round_off = width % 2
 * 
 *     cdef size_t top = row - offset             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_top = (__pyx_v_row - __pyx_v_offset);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":71
 * 
 *     cdef size_t top = row - offset
 *     cdef size_t bottom = row + offset             # <<<<<<<<<<<<<<
 *     cdef size_t left = col - offset
 ...
 */
  __pyx_v_bottom = (__pyx_v_row + __pyx_v_offset);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":72
 *     cdef size_t top = row - offset
 *     cdef size_t bottom = row + offset
 *     cdef size_t left = col - offset             # <<<<<<<<<<<<<<
 *     cdef size_t right = col + offset
 * 
 */
  __pyx_v_left = (__pyx_v_col - __pyx_v_offset);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":73
 *     cdef size_t bottom = row + offset
 *     cdef size_t left = col - offset
 *     cdef size_t right = col + offset             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_right = (__pyx_v_col + __pyx_v_offset);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":76
 * 
 *     # Compute bounded indices
 ...
 */
  ...
  __pyx_v_top_b = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":77
 *     # Compute bounded indices
 *     cdef size_t top_b = top if top > 0 else 0
 *     cdef size_t bottom_b = bottom if bottom < layer_height - 1 else layer_height - 1             # <<<<<<<<<<<<<<
 *     cdef size_t left_b = left if left > 0 else 0
 ...
 */
  if (((__pyx_v_bottom < (__pyx_v_layer_height - 1)) != 0)) {
    __pyx_t_1 = __pyx_v_bottom;
  } else {
    __pyx_t_1 = (__pyx_v_layer_height - 1);
  }
  __pyx_v_bottom_b = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":78
 *     cdef size_t top_b = top if top > 0 else 0
 *     cdef size_t bottom_b = bottom if bottom < layer_height - 1 else layer_height - 1
 *     cdef size_t left_b = left if left > 0 else 0             # <<<<<<<<<<<<<<
 *     cdef size_t right_b = right if right < layer_width - 1 else layer_width - 1
 ...
 */
  ...
  __pyx_v_left_b = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":79
 *     cdef size_t bottom_b = bottom if bottom < layer_height - 1 else layer_height - 1
 *     cdef size_t left_b = left if left > 0 else 0
 *     cdef size_t right_b = right if right < layer_width - 1 else layer_width - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (((__pyx_v_right < (__pyx_v_layer_width - 1)) != 0)) {
    __pyx_t_1 = __pyx_v_right;
  } else {
    __pyx_t_1 = (__pyx_v_layer_width - 1);
  }
  __pyx_v_right_b = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":82
 * 
 *     # If bounded and unbounded indices deviate, only assign to subsection of extracted raster
 ...
 */
  __pyx_v_a = (__pyx_v_top_b - __pyx_v_top);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":83
 *     # If bounded and unbounded indices deviate, only assign to subsection of extracted raster
 *     cdef size_t a = top_b - top
 *     cdef size_t b = width - (bottom - bottom_b)             # <<<<<<<<<<<<<<
 *     cdef size_t c = left_b - left
 ...
 */
  __pyx_v_b = (__pyx_v_width - (__pyx_v_bottom - __pyx_v_bottom_b));

  /* "fireml/processing/dataset/realtime/land_cover.pyx":84
 *     cdef size_t a = top_b - top
 *     cdef size_t b = width - (bottom - bottom_b)
 *     cdef size_t c = left_b - left             # <<<<<<<<<<<<<<
 *     cdef size_t d = width - (right - right_b)
 * 
 */
  __pyx_v_c = (__pyx_v_left_b - __pyx_v_left);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":85
 *     cdef size_t b = width - (bottom - bottom_b)
 *     cdef size_t c = left_b - left
 *     cdef size_t d = width - (right - right_b)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_d = (__pyx_v_width - (__pyx_v_right - __pyx_v_right_b));

  /* "fireml/processing/dataset/realtime/land_cover.pyx":88
 * 
 *     # raster[a:b, c:d] = land_cover_layer[top_b : bottom_b + round_off, left_b : right_b + round_off]
 ...
 */
  __pyx_t_2.data = __pyx_v_land_cover_layer.data;
  __pyx_t_2.memview = __pyx_v_land_cover_layer.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
  __pyx_t_3 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_2,
    __pyx_v_land_cover_layer.shape[0], __pyx_v_land_cover_layer.strides[0], __pyx_v_land_cover_layer.suboffsets[0],
    0,
    0,
    &__pyx_t_3,
    __pyx_v_top_b,
    (__pyx_v_bottom_b + __pyx_v_round_off),
    0,
    1,
    1,
    0,
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_2,
    __pyx_v_land_cover_layer.shape[1], __pyx_v_land_cover_layer.strides[1], __pyx_v_land_cover_layer.suboffsets[1],
    1,
    1,
    &__pyx_t_3,
    __pyx_v_left_b,
    (__pyx_v_right_b + __pyx_v_round_off),
    0,
    1,
    1,
    0,
...
__pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_memview_to_raster(__pyx_t_2, __pyx_v_raster);
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_2, 0);
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.land_cover.extract_raster", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "fireml/processing/dataset/realtime/land_cover.pyx":90
 *     copy_memview_to_raster(land_cover_layer[top_b : bottom_b + round_off, left_b : right_b + round_off], raster)
 * 
 * cdef void process_raster(             # <<<<<<<<<<<<<<
 *     float *raster,
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster(float *__pyx_v_raster, __Pyx_memviewslice __pyx_v_land_cover_data_out, size_t __pyx_v_width, size_t __pyx_v_land_cover_cell_size) {
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":98
 *     cdef size_t i, j
 * 
 *     for i in range(width):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":99
 * 
 *     for i in range(width):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             if raster[i * width + j] == MISSING_VALUE or raster[i * width + j] == UNKNOWN_VALUE:
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":100
 *     for i in range(width):
 *         for j in range(width):
 *             if raster[i * width + j] == MISSING_VALUE or raster[i * width + j] == UNKNOWN_VALUE:             # <<<<<<<<<<<<<<
 *                 raster[i * width + j] = NAN
 * 
 */
      __pyx_t_8 = (((__pyx_v_raster[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]) == __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_MISSING_VALUE) != 0);
      if (!__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = (((__pyx_v_raster[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]) == __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_UNKNOWN_VALUE) != 0);
      __pyx_t_7 = __pyx_t_8;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_7) {

        /* "fireml/processing/dataset/realtime/land_cover.pyx":101
 *         for j in range(width):
 *             if raster[i * width + j] == MISSING_VALUE or raster[i * width + j] == UNKNOWN_VALUE:
 *                 raster[i * width + j] = NAN             # <<<<<<<<<<<<<<
 * 
 *     # Pooling
 */
        (__pyx_v_raster[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]) = NAN;
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":104
 * 
 *     # Pooling
 ...
 *     else:
 */
  __pyx_t_7 = ((__pyx_v_land_cover_cell_size > __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE) != 0);
  if (__pyx_t_7) {

    /* "fireml/processing/dataset/realtime/land_cover.pyx":105
 *     # Pooling
 *     if land_cover_cell_size > LANDFIRE_CELL_SIZE:
 *         avg_pool_2d(raster, width, land_cover_data_out)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d(__pyx_v_raster, __pyx_v_width, __pyx_v_land_cover_data_out);
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":107
 *         avg_pool_2d(raster, width, land_cover_data_out)
 *     else:
 *         copy_raster_to_memview_2d(raster, land_cover_data_out)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  /*else*/ {
    __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_2d(__pyx_v_raster, __pyx_v_land_cover_data_out);
  }
  __pyx_L10:;
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":110
 * 
 * 
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_convert_evt_classes(float *__pyx_v_arr, size_t __pyx_v_width, __Pyx_memviewslice __pyx_v_evt_to_class) {
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":112
 * cdef void convert_evt_classes(float *arr, size_t width, short [:] evt_to_class) nogil:
 *     cdef size_t i, j
 *     for i in range(width):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":113
 *     cdef size_t i, j
 *     for i in range(width):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             arr[i * width + j] = evt_to_class[(<size_t> arr[i * width + j]) - 3000]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":114
 *     for i in range(width):
 *         for j in range(width):
 *             arr[i * width + j] = evt_to_class[(<size_t> arr[i * width + j]) - 3000]             # <<<<<<<<<<<<<<
 * 
 * """
 */
      __pyx_t_7 = (((size_t)(__pyx_v_arr[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)])) - 0xBB8);
      (__pyx_v_arr[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]) = (*((short *) ( /* dim=0 */ (__pyx_v_evt_to_class.data + __pyx_t_7 * __pyx_v_evt_to_class.strides[0]) )));
    }
  }
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":120
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_one_hot_encode(float *__pyx_v_arr, float *__pyx_v_out, size_t __pyx_v_width, unsigned int __pyx_v_num_one_hot_classes) {
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  size_t __pyx_v_k;
  size_t __pyx_v_class_ind;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  size_t __pyx_t_3;
  size_t __pyx_t_4;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":124
 *     cdef size_t class_ind;
 * 
 *     for i in range(width):             # <<<<<<<<<<<<<<
 *         for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":125
 * 
 *     for i in range(width):
 *         for j in range(width):             # <<<<<<<<<<<<<<
 *             class_ind = <size_t> arr[i * width + j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":126
 *     for i in range(width):
 *         for j in range(width):
 *             class_ind = <size_t> arr[i * width + j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_class_ind = ((size_t)(__pyx_v_arr[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]));

      /* "fireml/processing/dataset/realtime/land_cover.pyx":128
 *             class_ind = <size_t> arr[i * width + j]
 * 
 *             for k in range(num_one_hot_classes):             # <<<<<<<<<<<<<<
 *                 if class_ind == k:
 ...
 */
      __pyx_t_7 = __pyx_v_num_one_hot_classes;
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_k = __pyx_t_9;

        /* "fireml/processing/dataset/realtime/land_cover.pyx":129
 * 
 *             for k in range(num_one_hot_classes):
 *                 if class_ind == k:             # <<<<<<<<<<<<<<
 *                     out[k * width * width + i * width + j] = 1
 *                 else:
 */
        __pyx_t_10 = ((__pyx_v_class_ind == __pyx_v_k) != 0);
        if (__pyx_t_10) {

          /* "fireml/processing/dataset/realtime/land_cover.pyx":130
 *             for k in range(num_one_hot_classes):
 *                 if class_ind == k:
 *                     out[k * width * width + i * width + j] = 1             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          (__pyx_v_out[((((__pyx_v_k * __pyx_v_width) * __pyx_v_width) + (__pyx_v_i * __pyx_v_width)) + __pyx_v_j)]) = 1.0;
 ...
 */
        ...
        /* "fireml/processing/dataset/realtime/land_cover.pyx":132
 *                     out[k * width * width + i * width + j] = 1
 *                 else:
 *                     out[k * width * width + i * width + j] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        /*else*/ {
          (__pyx_v_out[((((__pyx_v_k * __pyx_v_width) * __pyx_v_width) + (__pyx_v_i * __pyx_v_width)) + __pyx_v_j)]) = 0.0;
        }
        __pyx_L9:;
      }
    }
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":134
 *                     out[k * width * width + i * width + j] = 0
 * 
 * cdef void process_raster_evt(             # <<<<<<<<<<<<<<
 *     float *raster,
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster_evt(float *__pyx_v_raster, float *__pyx_v_evt_raster, __Pyx_memviewslice __pyx_v_land_cover_data_out, size_t __pyx_v_width, size_t __pyx_v_land_cover_cell_size, unsigned char __pyx_v_should_convert_evt_classes, unsigned int __pyx_v_num_one_hot_classes, __Pyx_memviewslice __pyx_v_evt_to_class) {
  float *__pyx_v_raster_ptr;
  int __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":144
 *     short [:] evt_to_class
 * ) nogil:
 ...
 *     # Convert to classes
 */
  __pyx_v_raster_ptr = __pyx_v_raster;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":147
 * 
 *     # Convert to classes
 ...
 * 
 */
  __pyx_t_1 = (__pyx_v_should_convert_evt_classes != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/realtime/land_cover.pyx":148
 *     # Convert to classes
 *     if should_convert_evt_classes:
 *         convert_evt_classes(raster_ptr, width, evt_to_class)             # <<<<<<<<<<<<<<
 * 
 *     # One hot encode
 */
    __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_convert_evt_classes(__pyx_v_raster_ptr, __pyx_v_width, __pyx_v_evt_to_class);
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":151
 * 
 *     # One hot encode
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_num_one_hot_classes > 1) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/realtime/land_cover.pyx":152
 *     # One hot encode
 *     if num_one_hot_classes > 1:
 *         one_hot_encode(raster, evt_raster, width, num_one_hot_classes)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_one_hot_encode(__pyx_v_raster, __pyx_v_evt_raster, __pyx_v_width, __pyx_v_num_one_hot_classes);

    /* "fireml/processing/dataset/realtime/land_cover.pyx":154
 *         one_hot_encode(raster, evt_raster, width, num_one_hot_classes)
 * 
 *         raster_ptr = evt_raster             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_raster_ptr = __pyx_v_evt_raster;
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":157
 * 
 *     # Spatial pooling; behaves identically to 2d pooling if first dimension size is 1
 *     if land_cover_cell_size > LANDFIRE_CELL_SIZE:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_land_cover_cell_size > __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE) != 0);
  if (__pyx_t_1) {

    /* "fireml/processing/dataset/realtime/land_cover.pyx":158
 *     # Spatial pooling; behaves identically to 2d pooling if first dimension size is 1
 *     if land_cover_cell_size > LANDFIRE_CELL_SIZE:
 *        avg_pool_3d(raster_ptr, width, land_cover_data_out)             # <<<<<<<<<<<<<<
 * 
 *     else:
 */
    __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_3d(__pyx_v_raster_ptr, __pyx_v_width, __pyx_v_land_cover_data_out);
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":161
 * 
 *     else:
 ...
 */
  /*else*/ {
    __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_copy_raster_to_memview_3d(__pyx_v_raster_ptr, __pyx_v_land_cover_data_out);
  }
  __pyx_L5:;
...
/* "fireml/processing/dataset/realtime/land_cover.pyx":163
 *        copy_raster_to_memview_3d(raster_ptr, land_cover_data_out)
 * 
 * cdef void create_land_cover_data(             # <<<<<<<<<<<<<<
 *     Point* point,
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_create_land_cover_data(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *__pyx_v_point, __Pyx_memviewslice __pyx_v_land_cover_data_out, __Pyx_memviewslice __pyx_v_land_cover_layers, __Pyx_memviewslice __pyx_v_land_cover_layer_types, __Pyx_memviewslice __pyx_v_evt_to_class, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_DataConfig *__pyx_v_data_config, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform __pyx_v_t) {
  size_t __pyx_v_width;
  size_t __pyx_v_num_land_cover_layers;
  size_t __pyx_v_i;
  float *__pyx_v_raster;
  float *__pyx_v_evt_raster;
  size_t __pyx_t_1;
  int __pyx_t_2;
  size_t __pyx_t_3;
  size_t __pyx_t_4;
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":172
 *     Transform t
 * ) nogil:
 ...
 *     cdef size_t i
 */
  if (unlikely(__pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE == 0)) {
    #ifdef WITH_THREAD
  ...
  __pyx_v_width = (__pyx_v_data_config->window_size / __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":173
 * ) nogil:
 *     cdef size_t width = data_config.window_size // LANDFIRE_CELL_SIZE
 *     cdef size_t num_land_cover_layers = len(land_cover_layers)             # <<<<<<<<<<<<<<
 *     cdef size_t i
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_land_cover_layers); 
  __pyx_v_num_land_cover_layers = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":177
 * 
 ...
 * 
 */
  __pyx_v_raster = ((float *)malloc((((sizeof(float)) * __pyx_v_width) * __pyx_v_width)));

  /* "fireml/processing/dataset/realtime/land_cover.pyx":178
 *     # Need intermediate raster before shrinking with pooling
 *     cdef float *raster = <float *> malloc(sizeof(float) * width * width)
 *     cdef float *evt_raster = <float *> 0;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_evt_raster = ((float *)0);

  /* "fireml/processing/dataset/realtime/land_cover.pyx":180
 *     cdef float *evt_raster = <float *> 0;
 * 
 *     if data_config.num_one_hot_classes > 1:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_data_config->num_one_hot_classes > 1) != 0);
  if (__pyx_t_2) {

    /* "fireml/processing/dataset/realtime/land_cover.pyx":181
 * 
 *     if data_config.num_one_hot_classes > 1:
 *         evt_raster = <float *> malloc(sizeof(float) * width * width * data_config.num_one_hot_classes)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_evt_raster = ((float *)malloc(((((sizeof(float)) * __pyx_v_width) * __pyx_v_width) * __pyx_v_data_config->num_one_hot_classes)));
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":183
 *         evt_raster = <float *> malloc(sizeof(float) * width * width * data_config.num_one_hot_classes)
 * 
 *     for i in range(num_land_cover_layers):             # <<<<<<<<<<<<<<
 *         extract_raster(
 *             point,
 */
  __pyx_t_1 = __pyx_v_num_land_cover_layers;
  __pyx_t_3 = __pyx_t_1;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "fireml/processing/dataset/realtime/land_cover.pyx":187
 *             point,
 *             raster,
 *             land_cover_layers[i],             # <<<<<<<<<<<<<<
 *             width,
 *             t,
 */
    __pyx_t_5.data = __pyx_v_land_cover_layers.data;
    __pyx_t_5.memview = __pyx_v_land_cover_layers.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_land_cover_layers.strides[0];
        __pyx_t_5.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_5.shape[0] = __pyx_v_land_cover_layers.shape[1];
__pyx_t_5.strides[0] = __pyx_v_land_cover_layers.strides[1];
    __pyx_t_5.suboffsets[0] = -1;

__pyx_t_5.shape[1] = __pyx_v_land_cover_layers.shape[2];
__pyx_t_5.strides[1] = __pyx_v_land_cover_layers.strides[2];
    __pyx_t_5.suboffsets[1] = -1;

__pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_extract_raster(__pyx_v_point, __pyx_v_raster, __pyx_t_5, __pyx_v_width, __pyx_v_t);

    /* "fireml/processing/dataset/realtime/land_cover.pyx":184
 * 
 *     for i in range(num_land_cover_layers):
 *         extract_raster(             # <<<<<<<<<<<<<<
 *             point,
 ...
 */
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":191
 *             t,
 *         )
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    __pyx_t_2 = (((*((unsigned char *) ( /* dim=0 */ (__pyx_v_land_cover_layer_types.data + __pyx_t_6 * __pyx_v_land_cover_layer_types.strides[0]) ))) == __pyx_e_6fireml_10processing_7dataset_8realtime_5types_filter) != 0);
    if (__pyx_t_2) {

      /* "fireml/processing/dataset/realtime/land_cover.pyx":192
 *         )
 *         if land_cover_layer_types[i] == LandCoverLayerType.filter:
 *             continue;             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":194
 *             continue;
 * 
 *         elif land_cover_layer_types[i] == LandCoverLayerType.evt:             # <<<<<<<<<<<<<<
 *             process_raster_evt(
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    __pyx_t_2 = (((*((unsigned char *) ( /* dim=0 */ (__pyx_v_land_cover_layer_types.data + __pyx_t_6 * __pyx_v_land_cover_layer_types.strides[0]) ))) == __pyx_e_6fireml_10processing_7dataset_8realtime_5types_evt) != 0);
    if (__pyx_t_2) {

      /* "fireml/processing/dataset/realtime/land_cover.pyx":198
 *                 raster,
 *                 evt_raster,
 ...
 */
      __pyx_t_7.data = __pyx_v_land_cover_data_out.data;
      __pyx_t_7.memview = __pyx_v_land_cover_data_out.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_8 = -1;
      if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_7,
    __pyx_v_land_cover_data_out.shape[0], __pyx_v_land_cover_data_out.strides[0], __pyx_v_land_cover_data_out.suboffsets[0],
    0,
    0,
    &__pyx_t_8,
    __pyx_v_i,
    (__pyx_v_i + __pyx_v_data_config->num_one_hot_classes),
    0,
    1,
    1,
    0,
...
__pyx_t_7.shape[1] = __pyx_v_land_cover_data_out.shape[1];
__pyx_t_7.strides[1] = __pyx_v_land_cover_data_out.strides[1];
    __pyx_t_7.suboffsets[1] = -1;

__pyx_t_7.shape[2] = __pyx_v_land_cover_data_out.shape[2];
__pyx_t_7.strides[2] = __pyx_v_land_cover_data_out.strides[2];
    __pyx_t_7.suboffsets[2] = -1;

__pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster_evt(__pyx_v_raster, __pyx_v_evt_raster, __pyx_t_7, __pyx_v_width, __pyx_v_data_config->land_cover_cell_size, __pyx_v_data_config->should_convert_evt_classes, __pyx_v_data_config->num_one_hot_classes, __pyx_v_evt_to_class);

      /* "fireml/processing/dataset/realtime/land_cover.pyx":195
 * 
 *         elif land_cover_layer_types[i] == LandCoverLayerType.evt:
 *             process_raster_evt(             # <<<<<<<<<<<<<<
 *                 raster,
 ...
 */
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":207
 * 
 *         else:
 *             process_raster(             # <<<<<<<<<<<<<<
 *                 raster,
 ...
 */
    /*else*/ {
      ...
      /* "fireml/processing/dataset/realtime/land_cover.pyx":209
 *             process_raster(
 *                 raster,
 *                 land_cover_data_out[i],             # <<<<<<<<<<<<<<
 *                 width,
 *                 data_config.land_cover_cell_size ,
 */
      __pyx_t_9.data = __pyx_v_land_cover_data_out.data;
      __pyx_t_9.memview = __pyx_v_land_cover_data_out.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_9, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_land_cover_data_out.strides[0];
        __pyx_t_9.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_9.shape[0] = __pyx_v_land_cover_data_out.shape[1];
__pyx_t_9.strides[0] = __pyx_v_land_cover_data_out.strides[1];
    __pyx_t_9.suboffsets[0] = -1;

__pyx_t_9.shape[1] = __pyx_v_land_cover_data_out.shape[2];
__pyx_t_9.strides[1] = __pyx_v_land_cover_data_out.strides[2];
    __pyx_t_9.suboffsets[1] = -1;

__pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_process_raster(__pyx_v_raster, __pyx_t_9, __pyx_v_width, __pyx_v_data_config->land_cover_cell_size);
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":215
 * 
 * 
 *     free(raster)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":217
 *     free(raster)
 * 
 *     if data_config.num_one_hot_classes > 1:             # <<<<<<<<<<<<<<
 *         free(evt_raster)
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "fireml/processing/dataset/realtime/land_cover.pyx":218
 * 
 *     if data_config.num_one_hot_classes > 1:
 *         free(evt_raster)             # <<<<<<<<<<<<<<
 * 
 */
    free(__pyx_v_evt_raster);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
  __PYX_XDEC_MEMVIEW(&__pyx_t_9, 0);
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.land_cover.create_land_cover_data", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.dataset.realtime.land_cover.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.land_cover.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.land_cover.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.land_cover._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_land_cover(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_land_cover},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("create_land_cover_data", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_8realtime_10land_cover_create_land_cover_data, "void (struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_DataConfig *, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("fireml.processing.dataset.realtime.pooling"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "avg_pool_2d", (void (**)(void))&__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d, "void (float *, size_t const , __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "avg_pool_3d", (void (**)(void))&__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_3d, "void (float *, size_t const , __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initland_cover(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initland_cover(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_land_cover(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_land_cover(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_land_cover(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'land_cover' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_land_cover(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("land_cover", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__dataset__realtime__land_cover) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.dataset.realtime.land_cover")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.dataset.realtime.land_cover", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/dataset/realtime/land_cover.pyx":12
 * 
 * 
 ...
 * cdef short UNKNOWN_VALUE = -9999
 */
  __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_LANDFIRE_CELL_SIZE = 30;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":13
 * 
 * cdef size_t LANDFIRE_CELL_SIZE = 30
 * cdef short MISSING_VALUE = -32768             # <<<<<<<<<<<<<<
 * cdef short UNKNOWN_VALUE = -9999
 * 
 */
  __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_MISSING_VALUE = -32768;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":14
 * cdef size_t LANDFIRE_CELL_SIZE = 30
 * cdef short MISSING_VALUE = -32768
 * cdef short UNKNOWN_VALUE = -9999             # <<<<<<<<<<<<<<
 * 
 * cdef void copy_raster_to_memview_2d(
 */
  __pyx_v_6fireml_10processing_7dataset_8realtime_10land_cover_UNKNOWN_VALUE = -9999;

  /* "fireml/processing/dataset/realtime/land_cover.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.dataset.realtime.land_cover", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.dataset.realtime.land_cover");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
