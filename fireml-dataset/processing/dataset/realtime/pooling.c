...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.dataset.realtime.pooling",
        "sources": [
            "fireml/processing/dataset/realtime/pooling.pyx"
        ]
    },
    "module_name": "fireml.processing.dataset.realtime.pooling"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__dataset__realtime__pooling
#define __PYX_HAVE_API__fireml__processing__dataset__realtime__pooling
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
static double __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_mean_2d(float *, size_t, size_t, size_t, size_t, size_t); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.dataset.realtime.pooling"
extern int __pyx_module_is_main_fireml__processing__dataset__realtime__pooling;
int __pyx_module_is_main_fireml__processing__dataset__realtime__pooling = 0;

/* Implementation of 'fireml.processing.dataset.realtime.pooling' */
...
/* "fireml/processing/dataset/realtime/pooling.pyx":5
...
static double __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_mean_2d(float *__pyx_v_sel, size_t __pyx_v_width, size_t __pyx_v_start_i, size_t __pyx_v_end_i, size_t __pyx_v_start_j, size_t __pyx_v_end_j) {
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  double __pyx_v_acc;
  double __pyx_r;
  ...
  /* "fireml/processing/dataset/realtime/pooling.pyx":14
 *   ) nogil:
 *     cdef size_t i, j
 *     cdef double acc = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/pooling.pyx":16
 *     cdef double acc = 0
 * 
 *     for i in range(start_i, end_i):             # <<<<<<<<<<<<<<
 ...
 *             acc += sel[i * width + j]
 */
  __pyx_t_1 = __pyx_v_end_i;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = __pyx_v_start_i; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "fireml/processing/dataset/realtime/pooling.pyx":17
 * 
 *     for i in range(start_i, end_i):
 *         for j in range(start_j, end_j):             # <<<<<<<<<<<<<<
 *             acc += sel[i * width + j]
 * 
 */
    __pyx_t_4 = __pyx_v_end_j;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = __pyx_v_start_j; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "fireml/processing/dataset/realtime/pooling.pyx":18
 *     for i in range(start_i, end_i):
 *         for j in range(start_j, end_j):
 *             acc += sel[i * width + j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_acc = (__pyx_v_acc + (__pyx_v_sel[((__pyx_v_i * __pyx_v_width) + __pyx_v_j)]));
    }
  }

  /* "fireml/processing/dataset/realtime/pooling.pyx":20
 *             acc += sel[i * width + j]
 * 
 *     return acc / ((end_i - start_i) + (end_j - start_j))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = ((__pyx_v_end_i - __pyx_v_start_i) + (__pyx_v_end_j - __pyx_v_start_j));
  ...
  __pyx_r = (__pyx_v_acc / ((double)__pyx_t_1));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.pooling.mean_2d", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "fireml/processing/dataset/realtime/pooling.pyx":22
 *     return acc / ((end_i - start_i) + (end_j - start_j))
 * 
 * cdef void avg_pool_2d(float *arr, const size_t current_width, float [:,::1] result) nogil:             # <<<<<<<<<<<<<<
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d(float *__pyx_v_arr, size_t const __pyx_v_current_width, __Pyx_memviewslice __pyx_v_result) {
  size_t __pyx_v_target_width;
  double __pyx_v_width_ratio;
  size_t __pyx_v_start_i;
  size_t __pyx_v_end_i;
  size_t __pyx_v_start_j;
  size_t __pyx_v_end_j;
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  ...
  /* "fireml/processing/dataset/realtime/pooling.pyx":23
 * 
 * cdef void avg_pool_2d(float *arr, const size_t current_width, float [:,::1] result) nogil:
 *     cdef size_t target_width = result.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_target_width = (__pyx_v_result.shape[0]);

  /* "fireml/processing/dataset/realtime/pooling.pyx":25
 *     cdef size_t target_width = result.shape[0]
 * 
 *     cdef double width_ratio = current_width / target_width             # <<<<<<<<<<<<<<
 * 
 ...
 */
  if (unlikely(__pyx_v_target_width == 0)) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
  ...
  __pyx_v_width_ratio = (((double)__pyx_v_current_width) / ((double)__pyx_v_target_width));

  /* "fireml/processing/dataset/realtime/pooling.pyx":29
 *     cdef size_t start_i, end_i, start_j, end_j, i, j
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_target_width;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "fireml/processing/dataset/realtime/pooling.pyx":30
 * 
 *     for i in range(target_width):
 *         for j in range(target_width):             # <<<<<<<<<<<<<<
 *             start_i = <size_t> floor(i * width_ratio)
 ...
 */
    __pyx_t_4 = __pyx_v_target_width;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "fireml/processing/dataset/realtime/pooling.pyx":31
 *     for i in range(target_width):
 *         for j in range(target_width):
 *             start_i = <size_t> floor(i * width_ratio)             # <<<<<<<<<<<<<<
 *             end_i = <size_t> ceil((i+1) * width_ratio)
 ...
 */
      __pyx_v_start_i = ((size_t)floor((__pyx_v_i * __pyx_v_width_ratio)));

      /* "fireml/processing/dataset/realtime/pooling.pyx":32
 *         for j in range(target_width):
 *             start_i = <size_t> floor(i * width_ratio)
 *             end_i = <size_t> ceil((i+1) * width_ratio)             # <<<<<<<<<<<<<<
 *             start_j = <size_t> floor(j * width_ratio)
 ...
 */
      __pyx_v_end_i = ((size_t)ceil(((__pyx_v_i + 1) * __pyx_v_width_ratio)));

      /* "fireml/processing/dataset/realtime/pooling.pyx":33
 *             start_i = <size_t> floor(i * width_ratio)
 *             end_i = <size_t> ceil((i+1) * width_ratio)
 *             start_j = <size_t> floor(j * width_ratio)             # <<<<<<<<<<<<<<
 *             end_j = <size_t> ceil((j+1) * width_ratio)
 * 
 */
      __pyx_v_start_j = ((size_t)floor((__pyx_v_j * __pyx_v_width_ratio)));

      /* "fireml/processing/dataset/realtime/pooling.pyx":34
 *             end_i = <size_t> ceil((i+1) * width_ratio)
 *             start_j = <size_t> floor(j * width_ratio)
 *             end_j = <size_t> ceil((j+1) * width_ratio)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_end_j = ((size_t)ceil(((__pyx_v_j + 1) * __pyx_v_width_ratio)));

      /* "fireml/processing/dataset/realtime/pooling.pyx":36
 *             end_j = <size_t> ceil((j+1) * width_ratio)
 * 
 *             result[i,j] = mean_2d(arr, current_width, start_i, end_i, start_j, end_j)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_7 * __pyx_v_result.strides[0]) )) + __pyx_t_8)) )) = __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_mean_2d(__pyx_v_arr, __pyx_v_current_width, __pyx_v_start_i, __pyx_v_end_i, __pyx_v_start_j, __pyx_v_end_j);
    }
  }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.pooling.avg_pool_2d", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "fireml/processing/dataset/realtime/pooling.pyx":43
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_3d(float *__pyx_v_arr, size_t const __pyx_v_current_width, __Pyx_memviewslice __pyx_v_result) {
  ...
  /* "fireml/processing/dataset/realtime/pooling.pyx":44
 * """
 * cdef void avg_pool_3d(float *arr, const size_t current_width, float [:,:,::1] result) nogil:
 *     cdef size_t num_layers = result.shape[0]             # <<<<<<<<<<<<<<
 *     cdef size_t i
 * 
 */
  __pyx_v_num_layers = (__pyx_v_result.shape[0]);

  /* "fireml/processing/dataset/realtime/pooling.pyx":47
 *     cdef size_t i
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "fireml/processing/dataset/realtime/pooling.pyx":48
 * 
 *     for i in range(num_layers):
 *         avg_pool_2d(arr + (i * current_width * current_width), current_width, result[i])             # <<<<<<<<<<<<<<
 */
...
__pyx_t_4.shape[1] = __pyx_v_result.shape[2];
__pyx_t_4.strides[1] = __pyx_v_result.strides[2];
    __pyx_t_4.suboffsets[1] = -1;

__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d((__pyx_v_arr + ((__pyx_v_i * __pyx_v_current_width) * __pyx_v_current_width)), __pyx_v_current_width, __pyx_t_4);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.dataset.realtime.pooling.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.pooling.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.pooling.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.pooling._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("avg_pool_2d", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_2d, "void (float *, size_t const , __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("avg_pool_3d", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_8realtime_7pooling_avg_pool_3d, "void (float *, size_t const , __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__dataset__realtime__pooling) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.dataset.realtime.pooling")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.dataset.realtime.pooling", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/dataset/realtime/pooling.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.dataset.realtime.pooling", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.dataset.realtime.pooling");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
