...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "fireml.processing.dataset.realtime.meteorology",
        "sources": [
            "fireml/processing/dataset/realtime/meteorology.pyx"
        ]
    },
    "module_name": "fireml.processing.dataset.realtime.meteorology"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fireml__processing__dataset__realtime__meteorology
#define __PYX_HAVE_API__fireml__processing__dataset__realtime__meteorology
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
static __pyx_ctuple_unsigned__space_long__and_unsigned__space_long (*__pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window)(__Pyx_memviewslice, unsigned long const , unsigned long const , unsigned long const ); /*proto*/

/* Module declarations from 'libc.string' */

/* Module declarations from 'libc.stdio' */

/* Module declarations from 'fireml.processing.dataset.realtime.meteorology' */
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_11meteorology_create_meteorology_raster(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *, unsigned long, unsigned long, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform); /*proto*/
...
#define __Pyx_MODULE_NAME "fireml.processing.dataset.realtime.meteorology"
extern int __pyx_module_is_main_fireml__processing__dataset__realtime__meteorology;
int __pyx_module_is_main_fireml__processing__dataset__realtime__meteorology = 0;

/* Implementation of 'fireml.processing.dataset.realtime.meteorology' */
...
/* "fireml/processing/dataset/realtime/meteorology.pyx":6
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_11meteorology_create_meteorology_data(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *__pyx_v_point, __Pyx_memviewslice __pyx_v_meteorology_times, __Pyx_memviewslice __pyx_v_meteorology_xys, __Pyx_memviewslice __pyx_v_meteorology_data_out, __Pyx_memviewslice __pyx_v_meteorology_layers, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_meteorology_layer_types, CYTHON_UNUSED struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_DataConfig *__pyx_v_data_config, __Pyx_memviewslice __pyx_v_aggregate_lags, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform __pyx_v_t) {
  size_t __pyx_v_num_aggregate_lags;
  size_t __pyx_v_num_layers;
  size_t __pyx_v_current_layer;
  size_t __pyx_v_i;
  unsigned long __pyx_v_time_window_lower;
  unsigned long __pyx_v_time_window_upper;
  size_t __pyx_t_1;
  size_t __pyx_t_2;
  size_t __pyx_t_3;
  size_t __pyx_t_4;
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":17
 *     Transform t
 * ) nogil:
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":18
 * ) nogil:
 *     cdef size_t num_aggregate_lags = len(aggregate_lags)
 *     cdef size_t num_layers = meteorology_layers.shape[0]             # <<<<<<<<<<<<<<
 *     cdef size_t current_layer = 0
 *     cdef size_t i
 */
  __pyx_v_num_layers = (__pyx_v_meteorology_layers.shape[0]);

  /* "fireml/processing/dataset/realtime/meteorology.pyx":19
 *     cdef size_t num_aggregate_lags = len(aggregate_lags)
 *     cdef size_t num_layers = meteorology_layers.shape[0]
 *     cdef size_t current_layer = 0             # <<<<<<<<<<<<<<
 *     cdef size_t i
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":24
 * 
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_num_aggregate_lags;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "fireml/processing/dataset/realtime/meteorology.pyx":29
 * 
 ...
 */
    ...
    __pyx_v_time_window_lower = (*((unsigned long *) ( /* dim=0 */ (__pyx_v_aggregate_lags.data + __pyx_t_4 * __pyx_v_aggregate_lags.strides[0]) )));

    /* "fireml/processing/dataset/realtime/meteorology.pyx":30
 *         # Lags come in pairs of two defining upper and lower times
 *         time_window_lower = aggregate_lags[i * 2 + 0]
 *         time_window_upper = aggregate_lags[i * 2 + 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_time_window_upper = (*((unsigned long *) ( /* dim=0 */ (__pyx_v_aggregate_lags.data + __pyx_t_4 * __pyx_v_aggregate_lags.strides[0]) )));

    /* "fireml/processing/dataset/realtime/meteorology.pyx":38
 *                 meteorology_times,
 *                 meteorology_xys,
 ...
 *                 t
 */
    __pyx_t_5.data = __pyx_v_meteorology_data_out.data;
    __pyx_t_5.memview = __pyx_v_meteorology_data_out.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_5, 0);
    __pyx_t_6 = -1;
    if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_5,
    __pyx_v_meteorology_data_out.shape[0], __pyx_v_meteorology_data_out.strides[0], __pyx_v_meteorology_data_out.suboffsets[0],
    0,
    0,
    &__pyx_t_6,
    __pyx_v_current_layer,
    (__pyx_v_current_layer + __pyx_v_num_layers),
    0,
    1,
    1,
    0,
...
__pyx_t_5.shape[1] = __pyx_v_meteorology_data_out.shape[1];
__pyx_t_5.strides[1] = __pyx_v_meteorology_data_out.strides[1];
    __pyx_t_5.suboffsets[1] = -1;

__pyx_t_5.shape[2] = __pyx_v_meteorology_data_out.shape[2];
__pyx_t_5.strides[2] = __pyx_v_meteorology_data_out.strides[2];
    __pyx_t_5.suboffsets[2] = -1;

__pyx_f_6fireml_10processing_7dataset_8realtime_11meteorology_create_meteorology_raster(__pyx_v_point, __pyx_v_time_window_lower, __pyx_v_time_window_upper, __pyx_v_meteorology_times, __pyx_v_meteorology_xys, __pyx_t_5, __pyx_v_meteorology_layers, __pyx_v_t);

    /* "fireml/processing/dataset/realtime/meteorology.pyx":32
 *         time_window_upper = aggregate_lags[i * 2 + 1]
 * 
 *         create_meteorology_raster(             # <<<<<<<<<<<<<<
 *                 point,
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_5, 0);
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.meteorology.create_meteorology_data", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "fireml/processing/dataset/realtime/meteorology.pyx":44
 * 
 * 
...
static void __pyx_f_6fireml_10processing_7dataset_8realtime_11meteorology_create_meteorology_raster(struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *__pyx_v_point, unsigned long __pyx_v_time_window_lower, unsigned long __pyx_v_time_window_upper, __Pyx_memviewslice __pyx_v_meteorology_times, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_meteorology_xys, __Pyx_memviewslice __pyx_v_meteorology_data_out, __Pyx_memviewslice __pyx_v_meteorology_layers, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform __pyx_v_t) {
  size_t __pyx_v_num_layers;
  size_t __pyx_v_output_width;
  size_t __pyx_v_time_step;
  size_t __pyx_v_l;
  size_t __pyx_v_i;
  size_t __pyx_v_j;
  CYTHON_UNUSED unsigned long __pyx_v_current_time;
  unsigned long __pyx_v_start_ind;
  unsigned long __pyx_v_end_ind;
  size_t __pyx_v_num_timesteps;
  size_t __pyx_v_col;
  size_t __pyx_v_row;
  unsigned long __pyx_t_1;
  __pyx_ctuple_unsigned__space_long__and_unsigned__space_long __pyx_t_2;
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":54
 *     Transform t
 * ) nogil:
 *     cdef size_t num_layers = meteorology_layers.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":55
 * ) nogil:
 *     cdef size_t num_layers = meteorology_layers.shape[0]
 *     cdef size_t output_width = meteorology_data_out.shape[1]             # <<<<<<<<<<<<<<
 *     cdef size_t time_step, l, i, j
 ...
 */
  __pyx_v_output_width = (__pyx_v_meteorology_data_out.shape[1]);

  /* "fireml/processing/dataset/realtime/meteorology.pyx":57
 *     cdef size_t output_width = meteorology_data_out.shape[1]
 *     cdef size_t time_step, l, i, j
 *     cdef unsigned long current_time = point.datetime             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_point->datetime;
  __pyx_v_current_time = __pyx_t_1;

  /* "fireml/processing/dataset/realtime/meteorology.pyx":62
 * 
 *     # Get temporal window
 ...
 */
  __pyx_t_2 = __pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window(__pyx_v_meteorology_times, __pyx_v_point->datetime, __pyx_v_time_window_lower, __pyx_v_time_window_upper);
  __pyx_t_1 = __pyx_t_2.f0;
  __pyx_t_3 = __pyx_t_2.f1;
  __pyx_v_start_ind = __pyx_t_1;
  __pyx_v_end_ind = __pyx_t_3;

  /* "fireml/processing/dataset/realtime/meteorology.pyx":64
 *     start_ind, end_ind = sel_window.select_temporal_window(meteorology_times, point.datetime, time_window_lower, time_window_upper)
 * 
 *     cdef size_t num_timesteps = end_ind - start_ind             # <<<<<<<<<<<<<<
 * 
 *     # Get spatial "center"
 */
  __pyx_v_num_timesteps = (__pyx_v_end_ind - __pyx_v_start_ind);

  /* "fireml/processing/dataset/realtime/meteorology.pyx":67
 * 
 *     # Get spatial "center"
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":68
 *     # Get spatial "center"
 *     cdef size_t col = <size_t> apply_inverse_transform(t, point.x, point.y)[0]
 *     cdef size_t row = <size_t> apply_inverse_transform(t, point.x, point.y)[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":71
 * 
 *     # Find upper-left corner of spatial window
 ...
 * 
 */
  __pyx_v_col = (__pyx_v_col - ((__pyx_v_output_width - 1) / 2));

  /* "fireml/processing/dataset/realtime/meteorology.pyx":72
 *     # Find upper-left corner of spatial window
 *     col -= (output_width - 1) // 2
 *     row -= (output_width - 1) // 2             # <<<<<<<<<<<<<<
 * 
 *     # For each layer
 */
  __pyx_v_row = (__pyx_v_row - ((__pyx_v_output_width - 1) / 2));

  /* "fireml/processing/dataset/realtime/meteorology.pyx":75
 * 
 *     # For each layer
 ...
 */
  __pyx_t_4 = __pyx_v_num_layers;
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_l = __pyx_t_6;

    /* "fireml/processing/dataset/realtime/meteorology.pyx":77
 *     for l in range(num_layers):
 *         # Walk forward through time (average through timesteps)
 *         for time_step in range(start_ind, end_ind):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_1 = __pyx_t_3;
    for (__pyx_t_7 = __pyx_v_start_ind; __pyx_t_7 < __pyx_t_1; __pyx_t_7+=1) {
      __pyx_v_time_step = __pyx_t_7;

      /* "fireml/processing/dataset/realtime/meteorology.pyx":78
 *         # Walk forward through time (average through timesteps)
 *         for time_step in range(start_ind, end_ind):
 *             for i in range(output_width):             # <<<<<<<<<<<<<<
 *                 for j in range(output_width):
 ...
 */
      __pyx_t_8 = __pyx_v_output_width;
      __pyx_t_9 = __pyx_t_8;
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        __pyx_v_i = __pyx_t_10;

        /* "fireml/processing/dataset/realtime/meteorology.pyx":79
 *         for time_step in range(start_ind, end_ind):
 *             for i in range(output_width):
 *                 for j in range(output_width):             # <<<<<<<<<<<<<<
 *                     meteorology_data_out[l, i, j] += (meteorology_layers[l, time_step, row + i, col + j] / num_timesteps)
 */
        __pyx_t_11 = __pyx_v_output_width;
        __pyx_t_12 = __pyx_t_11;
        for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
          __pyx_v_j = __pyx_t_13;

          /* "fireml/processing/dataset/realtime/meteorology.pyx":80
 *             for i in range(output_width):
 *                 for j in range(output_width):
 *                     meteorology_data_out[l, i, j] += (meteorology_layers[l, time_step, row + i, col + j] / num_timesteps)             # <<<<<<<<<<<<<<
 */
          ...
          __pyx_t_16 = (__pyx_v_row + __pyx_v_i);
          __pyx_t_17 = (__pyx_v_col + __pyx_v_j);
          __pyx_t_18 = (*((float *) ( /* dim=3 */ ((char *) (((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_meteorology_layers.data + __pyx_t_14 * __pyx_v_meteorology_layers.strides[0]) ) + __pyx_t_15 * __pyx_v_meteorology_layers.strides[1]) ) + __pyx_t_16 * __pyx_v_meteorology_layers.strides[2]) )) + __pyx_t_17)) )));
          if (unlikely(__pyx_v_num_timesteps == 0)) {
            #ifdef WITH_THREAD
          ...
          *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_meteorology_data_out.data + __pyx_t_17 * __pyx_v_meteorology_data_out.strides[0]) ) + __pyx_t_16 * __pyx_v_meteorology_data_out.strides[1]) )) + __pyx_t_15)) )) += (__pyx_t_18 / ((float)__pyx_v_num_timesteps));
        }
      }
    }
  }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fireml.processing.dataset.realtime.meteorology.create_meteorology_raster", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fireml.processing.dataset.realtime.meteorology.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.meteorology.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.meteorology.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fireml.processing.dataset.realtime.meteorology._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_meteorology(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_meteorology},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("create_meteorology_data", (void (*)(void))__pyx_f_6fireml_10processing_7dataset_8realtime_11meteorology_create_meteorology_data, "void (struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Point *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_DataConfig *, __Pyx_memviewslice, struct __pyx_t_6fireml_10processing_7dataset_8realtime_5types_Transform)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "select_temporal_window", (void (**)(void))&__pyx_f_6fireml_10processing_7dataset_13select_window_select_temporal_window, "__pyx_ctuple_unsigned__space_long__and_unsigned__space_long (__Pyx_memviewslice, unsigned long const , unsigned long const , unsigned long const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmeteorology(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmeteorology(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_meteorology(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_meteorology(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_meteorology(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'meteorology' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_meteorology(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("meteorology", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fireml__processing__dataset__realtime__meteorology) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fireml.processing.dataset.realtime.meteorology")) {
      if (unlikely(PyDict_SetItemString(modules, "fireml.processing.dataset.realtime.meteorology", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fireml/processing/dataset/realtime/meteorology.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fireml.processing.dataset.realtime.meteorology", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fireml.processing.dataset.realtime.meteorology");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
